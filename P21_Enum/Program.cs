...
namespace P21_Enum
{
    class Program
    {
        ...
        //You can access enum item with the dot syntax.
        ...
        static void Main(string[] args)
        {
            ...
            int myNum = (int)Months.June;                  //To get the integer value from an item, you must explicity convert the item to an int
        ...
        {
            Low,
            Medium,             //Separate the enum item with comma
            High
        }
