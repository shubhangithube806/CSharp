...
namespace P11_Methods
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(MyMethod8(5, 8));
            ...
            Console.WriteLine("\n\n5. Named Arguments - ");
            MyMethod9(child3: "Jon", child1: "Liam", child2: "jenny");
            ...
            //Create a Method and Call a Method - 
        ...
        {
            Console.WriteLine(firstName1 +" Gunjal");
        }
        ...
        // (a) This example returns the sum of a method's two param
